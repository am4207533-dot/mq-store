const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-D6sZQtdb.js","assets/Layout-BE7aCRPw.js","assets/Shop-CHMqJLSl.js","assets/badge-CyokG2Kx.js","assets/About-XLzl0-ZL.js","assets/Contact-CByK7PNH.js","assets/circle-check-BYWx5eCe.js","assets/WatchDetail-C7ec-GBg.js"])))=>i.map(i=>d[i]);
...
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./Home-D6sZQtdb.js"), true ? __vite__mapDeps([0,1]) : void 0));
const ShopPage = reactExports.lazy(() => __vitePreload(() => import("./Shop-CHMqJLSl.js"), true ? __vite__mapDeps([2,1,3]) : void 0));
const AboutPage = reactExports.lazy(() => __vitePreload(() => import("./About-XLzl0-ZL.js"), true ? __vite__mapDeps([4,1]) : void 0));
const ContactPage = reactExports.lazy(() => __vitePreload(() => import("./Contact-CByK7PNH.js"), true ? __vite__mapDeps([5,1,6]) : void 0));
const WatchDetailPage = reactExports.lazy(() => __vitePreload(() => import("./WatchDetail-C7ec-GBg.js"), true ? __vite__mapDeps([7,1,3,6]) : void 0));
...
const shopRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/shop",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShopPage, {}) })
});
const watchDetailRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/shop/$watchId",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(WatchDetailPage, {}) })
});
const aboutRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/about",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AboutPage, {}) })
});
const contactRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/contact",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContactPage, {}) })
});
...
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-none items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-3xl font-bold tracking-[0.2em] text-foreground animate-pulse", children: "MQ" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[0.6rem] tracking-[0.4em] text-accent-gold uppercase", children: "STORE.PK" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-px section-divider" })
  ] }) });
}
function App() {
